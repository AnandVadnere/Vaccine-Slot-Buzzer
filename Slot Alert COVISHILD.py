...
PinCode ="425001" #Enter your pincode here
...
MyAge = 18 # Set your age here, there are different sessions for people having age 45+ and below
...
def SlotChecker():
    ...
    for c in Data['centers']:
        for s in c['sessions']:
            if (MyAge >= s['min_age_limit'] and s['vaccine'] == VaccineType.upper()) and (s['available_capacity_dose1'] > 0 and c['fee_type']=='Free'):
